...
<container1 id = contents1>
            <table class="con1_search">
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="reqInput" name="" disabled style="width: 100%;"/></td>
                    <td><i class="fas fa-search" style="color: blue;"></i></td>

                    <td colspan="5" style="width: 70px;">해당년도</td>
                    <td style="width: 80px;"><input type="number" id="reqInput" style="width: 100%; text-align: right;" value="2021" /></td>
